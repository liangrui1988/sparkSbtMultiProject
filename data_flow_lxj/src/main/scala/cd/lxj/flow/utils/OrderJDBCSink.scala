...
class OrderJDBCSink(url: String, user: String, pwd: String) extends ForeachWriter[Row] {
  ...
  def process(value: Row): Unit = {
    ...
    //    val sdate = value.getAs[String]("orderDate") expired, ${value.getAs[Boolean]("expired")},
    val sql =
    s"""
       |INSERT INTO order_stream_sink (orderNum,orderMoney,storeId,otype,orderDate)
       |VALUES (${value.getAs[Int]("orderNum")},${value.getAs[Double]("orderMoney")},
       |${value.getAs[Int]("storeId")},
